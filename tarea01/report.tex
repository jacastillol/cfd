...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.38]{008SolucionTeorica.png}\\
  \label{fig:solteo}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.38]{009Solu_Sch_Grid.png}\\
  \label{fig:sch_grid}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.38]{010Solu_Sch_non-uGrid.png}\\
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.38]{011Solu_Sch_non-uGrid-Good.png}\\
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.38]{012Solu_Trans_FE_Grid11pts.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.38]{013Solu_Trans_FE_nonUGrid11pts.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.38]{014Solu_Trans_RK4_Grid11pts.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.38]{015Solu_Trans_pts_t.png}
...
\begin{figure}[!htb]
  \centering
  \includegraphics[scale=0.5]{03_001Temporal.png}
  \includegraphics[scale=0.5]{03_002Temporal.png}\\
  \label{fig:tmpfig}
  \caption{Funcion de prueba para aproximar las primeras dos derivadas utilizando esquemas de diferencias finitas: (arriba) $f(x;\kappa_1,\kappa_2,\Delta_x)$, (centro) $\frac{df}{dx}$, (abajo) $\frac{d^2f}{dx^2}$}
\end{figure}
